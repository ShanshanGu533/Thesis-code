...
def extract_arabidopsis(filename):
    ...
    :return: new_lines: list of str, it contains only arabidopsis
    """
...
def select_certain_domain(prot2domain, prot2name, inter_list, domain1, domain2):
    """
    function to find real interactions
    :param prot2domain: dict, {protein: domain_domain}
    :param prot2name: dict, {protein: name}
    :param inter_list: list of str, it contains only arabidopsis
    :param domain1: str, domain from Pfam
    :param domain2: str, domain from Pfam
    :return: set, real interactions
    """
    domain1.sort()
    domain2.sort()
    tmp = ''
