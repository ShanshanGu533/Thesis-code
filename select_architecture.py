...
Usage: python3 select_architecture.py smart_file Pfam_file output
smart_file: str, files from SMART
Pfam_file: str, files from Pfam
...
def extract_smart(filename):
    ...
    :param filename: str, smart file
    :return: real_names: set, names of sequences
...
def extract_domain_pfam(filename, real_names, new_file):
    """function to extract sequences from MSA of Pfam

    :param filename: str, file from Pfam
    :param real_names: set, names of sequences
    :param new_file: str, output file
    :return: count, int, number of sequences
    """
    lines = open(filename).readlines()
    fasta_dict = {}
    for line in lines:
