...
Usage: python3 analyse_iter_labels.py inputfile_csv MSA.fasta
...
def count_Arath(filename):
    """
    function to count how many sequences from arabidopsis

    :param filename: str, MSA file
    :return:
    count: int, number of arabidopsis
    names: list, name of arabidopsis
    arath_row: list, index of predicted interacting sequences
    """
    lines = open(filename).readlines()
    count = 0
    names = []
