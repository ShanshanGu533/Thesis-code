...
def add_phylogenetic_effect(MSA_1, MSA_2):
    ...
    :param MSA_1: list of str, they are proteins in MSA1

    :param MSA_2: list of str, they are proteins in MSA2
    :return:
    MSA_1_phy: list of str, MSA1 with phylogenetic effects
    MSA_2_phy: list of str, MSA2 with phylogenetic effects
    """
    MSA_1_phy = []
    MSA_2_phy = []
    for seq in MSA_1:
