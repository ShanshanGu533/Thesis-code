...
def add_real_interaction(filename):
    ...
    :param filename: str, file contains real interactions
    :return: real_inters: list of list, list contains real interactions
    """
    real_inters = []
    lines = open(filename).readlines()
    for line in lines:
...
def extract_real_interactions(real_inters, protein_1_species, protein_1_names, protein_1_seqs, protein_2_species, protein_2_names, protein_2_seqs):
    ...
    :param real_inters: list of list, list contains real interactions
    :param protein_1_species:list of str, it contains species name
    :param protein_1_names:list of str, it contains seqs' names
    :param protein_1_seqs:list of str, it contains seqs
    :param protein_2_species:the same as above three lines, but protein 2
    ...
    :param protein_2_seqs:
    :return:
    protein_1_species: list of str, it contains species name
    protein_1_names: list of str, it contains seqs' names
    protein_1_seqs: list of str, it contains seqs
    protein_2_species: the same as above three lines, but protein 2
    protein_2_names:
    protein_2_seqs:
    MSA_1_name: list of str, name of MSA1
    MSA_1_seq: list of str, seq of MSA1
    MSA_2_name: list of str, name of MSA2
    MSA_2_seq: list of str, seq of MSA2
    """
    MSA_1_name = []
    MSA_1_seq = []
    MSA_2_name = []
