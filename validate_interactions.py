...
def map_protein_domains(interaction_list, prot_dict, domain_1_set, domain_2_set):
    """
    function to map proteins which contains certain domains
    :param interaction_list: list of str, it contains interactions
    :param prot_dict: dictionary, {protein: domain_domain}
    :param domain_1_set: set, domains
    :param domain_2_set: set, domains
    :return:
    """
...
def map_int_domains(interaction_list, prot_dict, domain_1_set, domain_2_set):
    ...
    :param domain_1_set: set, domains
    :param domain_2_set: set, domains
    :return: interaction_pairs_list: list, interaction pairs
    """
    interaction_pairs_list = []
